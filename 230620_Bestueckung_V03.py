...
class Kanalbelegung(Enum):
    kanal_programm = 9000
    kanal_programm_return = kanal_programm + 500
    kanal_hutschiene = 9002
    kanal_hutschiene_return = kanal_hutschiene + 500
    kanal_hutschiene_handshake = 9004
    kanal_hutschiene_handshake_return = kanal_hutschiene_handshake + 500
    kanal_reihenfolge = 9101
    kanal_reihenfolge_return = kanal_reihenfolge + 500
    kanal_reihenfolge_handshake = 9006
    kanal_reihenfolge_handshake_return = kanal_reihenfolge_handshake + 500
    kanal_betrieb_handshake = 9008
    kanal_betrieb_handshake_return = kanal_betrieb_handshake + 500
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.getAnzahlKlemmen.setValue(6)
        self.ui.getAnzahlHutschienen.setValue(8)
        self.ui.getMaxKlemmenHutschiene.setValue(20)
    ...
    def get_anzahl_klemmen(self):
        return self.eingabe_nur_integer(self.ui.getAnzahlKlemmen.value())

    # Anzahl von Hutschienen aus GUI-Eingabefeld einlesen
    def get_anzahl_hutschienen(self):
        return self.eingabe_nur_integer(self.ui.getAnzahlHutschienen.value())

    # Klemmenlimit aus GUI-Eingabefeld einlesen
    def get_klemmenlimit_hutschiene(self):
        return self.eingabe_nur_integer(self.ui.getMaxKlemmenHutschiene.value())
    ...
    def init_parameter(self):
        ...
        self.ui.Absenden.setEnabled(False)
    ...
    def kommunikation_roboter(self, kanal, value, zeit):
        ...
        print("Wurde geschrieben auf Kanal:", kanal, "Status", self.roboter.read_dint(kanal, 10))
    ...
    def roboter_starten(self):
        ...
        self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene_return.value, [0], 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene_handshake.value, [0], 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene_handshake_return.value, [0], 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge.value, [0] * 50, 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge_return.value, [0] * 50, 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge_handshake.value, [0], 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge_handshake_return.value, [0], 0.2)
        for i in range(1, roboter_hutschienen):
            ...
            self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene_handshake.value, [1], 0.2)
            self.ui.label_command.setText("Schiene wurde ausgewählt")
            print("Schiene wurde ausgewählt")
            # print(reihenfolge)
            time.sleep(1)
            self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge.value, reihenfolge, 1)
            self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge_handshake.value, [1], 1)
            self.ui.label_command.setText("Hutschiene wurde übertragen")
            print(Kanalbelegung.kanal_reihenfolge_handshake_return.value)
            if self.roboter.read_dint(Kanalbelegung.kanal_reihenfolge_handshake_return.value, 1) == [1]:
                print("test")
                self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene.value, [0], 1)
                self.kommunikation_roboter(Kanalbelegung.kanal_hutschiene_handshake.value, [0], 1)
                self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge.value, [0] * 50, 1)
                self.kommunikation_roboter(Kanalbelegung.kanal_reihenfolge_handshake.value, [0], 1)
                print("warten auf Null Return")
                self.warten_auf_roboter(Kanalbelegung.kanal_hutschiene_return.value, 0)
                self.warten_auf_roboter(Kanalbelegung.kanal_hutschiene_handshake_return.value, 0)
                self.warten_auf_roboter(Kanalbelegung.kanal_reihenfolge_return.value, 0)
                self.warten_auf_roboter(Kanalbelegung.kanal_reihenfolge_handshake_return.value, 0)
            ...
            self.ui.label_command.setText("Ihre Daten wurde erfolgreich auf den Roboter übertragen")
        ...
        self.warten_auf_roboter(Kanalbelegung.kanal_betrieb_handshake_return.value, 1)
        self.ui.label_command.setText("Vorsicht, Roboter beginnt Platzierung!")
        self.warten_auf_roboter(Kanalbelegung.kanal_programm_return.value, 999)
        self.ui.label_command.setText("Platzierung erfolgreich!")
        self.kommunikation_roboter(Kanalbelegung.kanal_programm.value, [0], 0.2)
        self.kommunikation_roboter(Kanalbelegung.kanal_betrieb_handshake.value, [0], 0.2)
        self.ui.label_command.setText("Programm beendet!")
